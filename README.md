...
Five days of paired daily research: each day one knowledge gap named, one explainer written, both published publicly.

```
week-12/
├── pair_DAY_1/          # Monday 2026-05-04
├── pair_DAY_2/          # Tuesday 2026-05-05
├── pair_DAY_3/          # Wednesday 2026-05-06
├── pair_DAY_4/          # Thursday 2026-05-07
├── pair_DAY_5/          # Friday 2026-05-08
├── synthesis.md         # 1,500-word week synthesis
...
| `signoff.md` | Partner's gap-closure judgment |
| `grounding_commit.md` | Pointer to actual edit made to Week 10/11 portfolio |
