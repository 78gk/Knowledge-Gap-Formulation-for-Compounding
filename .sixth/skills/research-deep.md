...
python .sixth/skills/research/validate_json.py -f {fields_path} -j {output_path}
...
## Validation
After completing JSON output, run validation script to ensure complete field coverage:
python .sixth/skills/research/validate_json.py -f {project_dir}/fields.yaml -j {project_dir}/results/GitHub_Copilot.json
